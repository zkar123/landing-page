...
const coverImage = "/src/assets/images/usdtfarm2.png";
...
.<br class="hidden lg:block" />{" "}
                <span class="hidden lg:inline">Our USDT Farm is your gateway to a bountiful harvest of stable earnings  </span> <span class="text-[#039de1]">in the world of decentralized finance</span> +{" "}
              ...
              <div class="max-w-3xl mx-auto">
                <p class="text-xl text-gray-600 mb-8 dark:text-slate-400">
                  ...
                  🌾 Get ready to sow the seeds of financial growth and cultivate your crypto assets with us. ,{" "}
                ...
                <div class="flex flex-col flex-nowrap gap-4 m-auto max-w-xs sm:flex-row sm:justify-center sm:max-w-md lg:justify-start lg:m-0 lg:max-w-7xl">
                  ...
                  <div class="flex w-full sm:w-auto">
                    <button class="btn w-full bg-gray-50 dark:bg-transparent">Telegram</button>
                  </div>
                </div>
              </div>
            </div>
